...
test_that("fm_generate_graphs works", {
  ...
  if(test_resolution == "small"){
    ...
    #' @description Testing that the result of `fm_generate_graphs()` is stable
    expect_equal(
...
fusen::inflate(flat_file = "dev/flat_fm_generate_graphs.Rmd", vignette_name = "Dev - Generate Graphs", check = FALSE)
```
