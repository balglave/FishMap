...
```
## [1] "converge_output.rds" "obj_input.rds"       "opt_output.rds"     
## [4] "report_output.rds"
```
...
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output/converge_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output/obj_input.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output/opt_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output/report_output.rds
```
...
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output_rerun/converge_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output_rerun/obj_input.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output_rerun/opt_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/thinkr_output_rerun/report_output.rds
```
...
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/jc_output/converge_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/jc_output/obj_input.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/jc_output/opt_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/jc_output/report_output.rds
```
...
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/ba_output/shared/outputs_fishmap/converge_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/ba_output/shared/outputs_fishmap/obj_input.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/ba_output/shared/outputs_fishmap/opt_output.rds
## /tmp/RtmppNtHpz/fishmap_check1d5d3f3263a1/ba_output/shared/outputs_fishmap/report_output.rds
```
...
##   ... ...                          ...                      and 26684 more ...
## 
## baptiste$log_notencounterprob_com vs thinkr$log_notencounterprob_com
## - -1.247080
## + -1.082115
## - -0.919281
## + -1.087237
...
```
## body(environment(juliette$fn)$dataSanitize)[2:8] vs body(environment(thinkr$fn)$dataSanitize)[2:8]
##   `    if (is.list(x)) `
...
We encounter an error when contrasting the `fn` and `env` element of the `obj_input.rds` object between Baptiste's version and ThinkR's version. We run `{waldo}` element by element except object of class `environment`, with a specific parameter (`ignore_function_env = TRUE`) that ignore function environment comparison and allows the comparison to succeed. This error might come from a difference in package version (cf. comment at the beginning of section).
